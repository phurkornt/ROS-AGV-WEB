...
NAV2D.ImageMapClientNav = function(a) {
    ...
    e.on("change", function() {
        ...
        }), b.viewer.scaleToDimensions(e.currentImage.width, e.currentImage.height), b.viewer.shift(e.currentImage.pose.position.x, e.currentImage.pose.position.y)
    })
    ...
    if (l.subscribe(function(a) {
        ...
        }), g === !1) this.rootObject.addEventListener("dblclick", function(a) {
        ...
        var m = null,
            ...
            t = 0,
            u = function(a, d) {
                // if ("down" === d) m = h.globalToRos(a.stageX, a.stageY), n = new ROSLIB.Vector3(m), r = !0;
                // else if ("move" === d) {
